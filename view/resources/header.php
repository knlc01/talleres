        ...
        <aside class="sidebar">
            <div id="leftside-navigation" class="nano">
                ...
                <ul class="nano-content">
                    ...
                    <!-- MI CODIGO -->
                    <?php //echo $_SESSION['dashboard'];
                    //$_SESSION['maquinas']=1;
                     if ($_SESSION['maquinas']==1) { ?>
                    <li class="<?php if(isset($active1)){echo $active1;}?>">
                        <a href="./?view=maquinas"><i class="fa fa-users"></i><span>Maquinas</span></a>
                    </li>
                    <?php } ?>

                    <?php if ($_SESSION['maquinas']==1) { ?>
                    <li class="<?php if(isset($active4)){echo $active4;}?>">
                        <a href="./?view=clientes"><i class="fa fa-indent"></i><span>Clientes</span></a>
                    </li>
                    <?php } ?>

                    <?php if ($_SESSION['ordenes']==1) { ?>
                    <li class="<?php if(isset($active5)){echo $active5;}?>">
                        <a href="./?view=ordenes"><i class="fa fa-lock"></i><span>Ordenes</span></a>
                    </li>
                    <?php } ?>

                    <?php if ($_SESSION['empresa']==1) { ?>
                    <li class="<?php if(isset($active6)){echo $active6;}?>">
                        <a href="./?view=empresas"><i class="fa fa-building-o"></i><span>Repuestos</span></a>
                    </li>
                    <?php } ?>

                    <?php if ($_SESSION['sector']==1) { ?>
                    <li class="<?php if(isset($active7)){echo $active7;}?>">
                        <a href="./?view=sectores"><i class="fa fa-road"></i><span>Pedidos</span></a>
                    </li>
                    <?php } ?>
                    ...
                    ESTE HTML ESTABA COMENTADO <li class=" ?php if(isset($active5)){echo $active5;}?>">
